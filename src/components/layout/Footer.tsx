...
export default function Footer() {
  ...
  const productLinks = [
    { href: '/products?cat=herbs', labelAr: 'الأعشاب والمنقوعات', labelEn: 'Herbs & Infusions' },
    { href: '/products?cat=seeds', labelAr: 'البذور', labelEn: 'Seeds' },
    { href: '/products?cat=spices', labelAr: 'التوابل', labelEn: 'Spices' },
    { href: '/products?cat=dehydrated', labelAr: 'الخضروات المجففة', labelEn: 'Dehydrated Vegetables' },
  ];

  const navLinks = [
    { href: '/', labelAr: 'الرئيسية', labelEn: 'Home' },
    { href: '/about', labelAr: 'من نحن', labelEn: 'About Us' },
    { href: '/quality', labelAr: 'الجودة', labelEn: 'Quality' },
    { href: '/certificates', labelAr: 'شهاداتنا', labelEn: 'Certificates' },
